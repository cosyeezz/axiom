...
const MODULE_INFO = {
  ...
  "public/model-picker.css": "共享收藏下拉：暗色浮层、星标、触屏与焦点样式",
  ...
  "public/tooltip.css": "共享暗色悬停说明样式",
  "public/text-contrast.js": "文字对比度按钮、实时调节与本地偏好",
  "public/text-contrast.css": "文字专用对比度档位与调节面板",
