...
# Axiom 多级代码索引（生成于 2026/9/12 12:33:14）

## L1 模块总览（文件 → 职责）

| 文件 | 行数 | 职责 | 关键符号 |
|---|---|---|---|
| public/app.js | 3206 | 前端唯一入口：视图栈、WS 客户端、会话/设置 UI、渲染调度 | filePicker, $, ws, sessionMissing |
...
### public/app.js（3206 行） — 前端唯一入口：视图栈、WS 客户端、会话/设置 UI、渲染调度
...
| renderContextResults | function | 2659 |
| showContextSkills | function | 2679 |
| positionContextSkills | function | 2684 |
| showContextSkills | method | 2696 |
| controls | method | 2731 |
| skillTrigger | const | 2733 |
| showContextSkills | method | 2749 |
| resizePrompt | method | 2758 |
| controls | method | 2759 |
| closeCompletion | function | 2762 |
| highlightCompletion | function | 2770 |
| chooseCompletion | function | 2779 |
| closeCompletion | method | 2789 |
| updateCompletion | function | 2792 |
| closeCompletion | method | 2793 |
| resizePrompt | method | 2846 |
| controls | method | 2847 |
| switchSession | method | 2887 |
| creationLoad | const | 2898 |
| refreshPresets | function | 2899 |
| createAgentPicker | function | 2934 |
| options | method | 2960 |
| fill | method | 2968 |
| fillThinking | method | 2976 |
| options | method | 2978 |
| loadCreation | function | 3025 |
| openCreation | function | 3061 |
| rememberCreation | const | 3082 |
| updateDefaultsPreview | function | 3114 |
| updateDefaultsPreview | method | 3138 |
| controls | method | 3193 |
