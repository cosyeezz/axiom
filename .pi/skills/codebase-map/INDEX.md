...
# Axiom 多级代码索引（生成于 2026/9/10 03:17:12）

## L1 模块总览（文件 → 职责）

| 文件 | 行数 | 职责 | 关键符号 |
|---|---|---|---|
| public/app.js | 1023 | 前端唯一入口：视图栈、WS 客户端、会话/设置 UI、渲染调度 | $, ws, allSessions, views |
| public/index.html | 199 | 页面骨架与元素 id（见 L3） | - |
...
| public/style.css | 840 | 全局样式（CSP 禁 inline style，样式一律进这里） | - |
...
| src/pi.js | 168 | createPiFactory：封装 pi-coding-agent，按 selection 组装会话（模型/能力/思考档） | agentRuntime, createPiFactory |
...
| tests/app.test.js | 607 | node --test 测试（npm test） | - |
...
### public/app.js（1023 行） — 前端唯一入口：视图栈、WS 客户端、会话/设置 UI、渲染调度
...
| renderRuntime | method | 172 |
| options | method | 173 |
| fillSubagentModels | method | 178 |
| fillModels | method | 180 |
| options | method | 181 |
| configure | function | 187 |
| controls | method | 190 |
| controls | method | 213 |
| openCreation | method | 215 |
| card | function | 223 |
| renderMessage | function | 262 |
| renderQueue | function | 279 |
| event | function | 295 |
| snapshot | function | 395 |
| clearTimeout | method | 396 |
| renderQueue | method | 466 |
| applyConfig | method | 468 |
| controls | method | 469 |
| reconnectTimer | const | 471 |
| clearTimeout | method | 475 |
| controls | method | 478 |
| scheduleReconnect | function | 553 |
| clearTimeout | method | 554 |
| fillModels | method | 561 |
| fillSubagentModels | method | 568 |
| controls | method | 586 |
| scrollLatest | method | 591 |
| escapeTimer | const | 622 |
| withdrawQueue | function | 623 |
| refreshing | const | 670 |
| refreshSessions | function | 671 |
| updateSessions | function | 678 |
| renderSessions | method | 684 |
| switchSession | function | 686 |
| saveView | method | 688 |
| controls | method | 691 |
| renderSessions | function | 703 |
| sessionAction | const | 769 |
| openSessionAction | function | 770 |
| resizePrompt | method | 812 |
| controls | method | 813 |
| switchSession | method | 816 |
| creationLoad | const | 818 |
| createAgentPicker | function | 819 |
| options | method | 841 |
| fill | method | 849 |
| fillThinking | method | 857 |
| options | method | 859 |
| loadCreation | function | 905 |
| openCreation | function | 933 |
| updateDefaultsPreview | function | 950 |
| updateDefaultsPreview | method | 963 |
...
### src/pi.js（168 行） — createPiFactory：封装 pi-coding-agent，按 selection 组装会话（模型/能力/思考档）
...
- HTML id：sidebar、workspace-picker、workspace-name、workspace-form、cwd、workspaces、new、custom-new、search、sessions、open-settings、sidebar-backdrop、toggle-sidebar、session-title、workspace-label、status、login、connect、workspace、transcript、output、latest、message-queue、composer、prompt、provider、model、thinking、stop、send-steer、send-followup、send、session-runtime、composer-help、error、session-action、session-action-form、session-action-title、session-action-description、session-name-label、session-name、session-action-error、session-action-cancel、session-action-submit、task-overlays、task-template、settings、settings-title、defaults-panel、queue-type、steer-help、followup-help、defaults-preview、subagent-title、subagent-help、subagent-provider、subagent-model、settings-feedback、defaults-title、defaults-editor、create-session、create-title、create-form、create-workspace、create-defaults-help、create-agents、create-trust-row、create-trust、create-feedback、create-submit（public/index.html）
